...
export const Slider = () => {
    ...
    const length = sliderData.length;
        ...
        <div className='max-w-[1240px] mx-auto px-4 py-16 relative flex justify-center itmes-center'>
            <BsArrowLeftSquareFill onClick={prevSlide} className='absolute top-[50%] text-3xl text-white cursor-pointer left-8 hover:text-blue-100 duration-300'
            />
            <BsArrowRightSquareFill onClick={nextSlide} className='absolute top-[50%] text-3xl text-white cursor-pointer right-8 hover:text-blue-100 duration-300'/>
